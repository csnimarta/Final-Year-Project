    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                <Text style={styles.Text}>Cleaning Service Providers</Text>
                <LottieView style={{
                    height: "100%",
                    width: "60%",
                    top: responsiveHeight(-4)
                }} source={require('../../assets/animations/cleaning.json')} autoPlay
                    loop={true}
                />
            </View>
                    ...
                    <View style={styles.scrollContainer}>
                        <View style={styles.Container}>
                            ...
                            <TouchableOpacity style={{
                                ...
                                <View style={styles.detailsContainer}>
                                    <Text style={styles.detailsText}><Text style={styles.boldText}>Service type : </Text>Maid</Text>
